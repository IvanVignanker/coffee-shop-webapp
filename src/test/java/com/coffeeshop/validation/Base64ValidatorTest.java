...
public class Base64ValidatorTest {
    ...
    private Base64Size getInstanceOfAnnotation(int size) {
        Map<String, Object> annotationParam = new HashMap<>();
        annotationParam.put("maxSizeKb", size);
        base64SizeAnnotation = TypeFactory.annotation(Base64Size.class, annotationParam);
