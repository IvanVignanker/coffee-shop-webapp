export class Characteristics {
  ...
  constructor(bitterFrom: number, bitterTo: number, sourFrom: number, sourTo: number, strongFrom: number,
              strongTo: number, decaf: boolean, ground: boolean, coffeeType: string) {
